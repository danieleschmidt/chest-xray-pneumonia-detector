...
class DependencySecurityScanner:
    ...
    def _scan_with_pip_audit(
        self, requirements_file: str = None
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--requirements-file", type=str, help="Path to requirements file to scan"
    )
    parser.add_argument(
        "--output-json", type=str, help="Save scan results to JSON file"
    )
...
def main():
    ...
    if result.scan_tool == "manual":
        ...
        print(
            "   Install pip-audit or safety for comprehensive vulnerability scanning:"
        )
