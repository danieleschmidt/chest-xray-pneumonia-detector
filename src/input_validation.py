...
def validate_file_path(
    ...
    try:
        ...
        str(pathlib.Path(normalized_path).resolve())  # Validate path
...
def validate_model_path(model_path: str, must_exist: bool = True) -> str:
    ...
    return validate_file_path(
        model_path, must_exist=must_exist, allowed_extensions=allowed_extensions
    )
...
def validate_image_path(image_path: str, must_exist: bool = True) -> str:
    ...
    return validate_file_path(
        image_path, must_exist=must_exist, allowed_extensions=allowed_extensions
    )
